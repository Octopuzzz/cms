...
type ComplexityRoot struct {
	Mutation struct {
		Create func(childComplexity int, service string, data map[string]any) int
		Delete func(childComplexity int, service string, id string) int
		Update func(childComplexity int, service string, id string, data map[string]any) int
	}

	Query struct {
		Data func(childComplexity int, service string, id string) int
		List func(childComplexity int, service string, page *int, limit *int, search *string) int
	}
}

type MutationResolver interface {
	Create(ctx context.Context, service string, data map[string]any) (map[string]any, error)
	Update(ctx context.Context, service string, id string, data map[string]any) (map[string]any, error)
	Delete(ctx context.Context, service string, id string) (*bool, error)
}
type QueryResolver interface {
	Data(ctx context.Context, service string, id string) (map[string]any, error)
	List(ctx context.Context, service string, page *int, limit *int, search *string) ([]map[string]any, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.create":
		if e.ComplexityRoot.Mutation.Create == nil {
			break
		}
		...
		return e.ComplexityRoot.Mutation.Create(childComplexity, args["service"].(string), args["data"].(map[string]any)), true
	case "Mutation.delete":
		...
		return e.ComplexityRoot.Mutation.Delete(childComplexity, args["service"].(string), args["id"].(string)), true
	case "Mutation.update":
		if e.ComplexityRoot.Mutation.Update == nil {
			break
		}
		...
		return e.ComplexityRoot.Mutation.Update(childComplexity, args["service"].(string), args["id"].(string), args["data"].(map[string]any)), true

	case "Query.data":
		if e.ComplexityRoot.Query.Data == nil {
			break
		}
		...
		return e.ComplexityRoot.Query.Data(childComplexity, args["service"].(string), args["id"].(string)), true
	...
	case "Query.list":
		...
		return e.ComplexityRoot.Query.List(childComplexity, args["service"].(string), args["page"].(*int), args["limit"].(*int), args["search"].(*string)), true
...
type Query {
  # Generic access to dynamic services
  data(service: String!, id: ID!): JSON
  list(service: String!, page: Int, limit: Int, search: String): [JSON]
}

type Mutation {
  # Generic mutation for dynamic services
  create(service: String!, data: JSON!): JSON
  update(service: String!, id: ID!, data: JSON!): JSON
  delete(service: String!, id: ID!): Boolean
}
`, BuiltIn: false},
}
...
func (ec *executionContext) field_Mutation_create_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "service", ec.unmarshalNString2string)
	if err != nil {
		return nil, err
	}
	args["service"] = arg0
...
func (ec *executionContext) field_Mutation_update_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["id"] = arg1
	arg2, err := graphql.ProcessArgField(ctx, rawArgs, "data", ec.unmarshalNJSON2map)
	if err != nil {
		return nil, err
	}
	args["data"] = arg2
...
func (ec *executionContext) _Mutation_create(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			...
			return ec.Resolvers.Mutation().Create(ctx, fc.Args["service"].(string), fc.Args["data"].(map[string]any))
		},
		nil,
		ec.marshalOJSON2map,
		true,
...
func (ec *executionContext) _Mutation_update(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().Update(ctx, fc.Args["service"].(string), fc.Args["id"].(string), fc.Args["data"].(map[string]any))
		},
		nil,
		ec.marshalOJSON2map,
		true,
...
func (ec *executionContext) _Mutation_delete(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().Delete(ctx, fc.Args["service"].(string), fc.Args["id"].(string))
		},
		nil,
...
func (ec *executionContext) _Query_data(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.OperationContext,
		field,
		ec.fieldContext_Query_data,
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Query().Data(ctx, fc.Args["service"].(string), fc.Args["id"].(string))
		},
		nil,
		ec.marshalOJSON2map,
		true,
...
func (ec *executionContext) _Query_list(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Query().List(ctx, fc.Args["service"].(string), fc.Args["page"].(*int), fc.Args["limit"].(*int), fc.Args["search"].(*string))
		},
		nil,
		ec.marshalOJSON2ᚕmap,
		true,
		false,
	)
}
