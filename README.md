...
internal/
  ...
  cms/                      # Control plane operations
  config/                   # Application configuration
  database/                 # Database connectors and connection manager
  graphql/                  # Optional GraphQL gateway implementation
  handlers/                 # HTTP request handlers (Presentation layer)
  middleware/               # Authentication, tracing, logging middlewares
  models/                   # Domain entities and metadata definitions
  services/                 # Business logic and use case implementions
    auth_service.go
    backup_service.go       # Backup and restore engine
    dbconn_service.go       # Database connection manager
    dynamic_data_service.go # Dynamic CRUD & Query Engine
    migration_service.go    # Schema migration engine
    service_service.go      # Service Builder
    user_service.go
  tracing/                  # Observability (OpenTelemetry) setup
pkg/
  logger/                   # Structured logging setup (Zap)
  response/                 # API Response wrappers
tests/
  unit/                     # Unit tests (min 80% coverage)
  integration/              # Integration tests
  uat/                      # User Acceptance Tests
docker/                     # Docker and container configuration files
docs/                       # Swagger / OpenAPI auto-generated files
```
